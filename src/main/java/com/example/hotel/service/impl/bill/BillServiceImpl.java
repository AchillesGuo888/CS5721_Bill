...
public class BillServiceImpl implements BillService {
  ...
  public Boolean payBill(PayBillRequestDTO requestDTO) throws BizException {
    ...
    insertNewPayment(requestDTO);
    return true;
  }

  private void insertNewPayment(PayBillRequestDTO requestDTO) {
    PaymentInfo paymentInfo = new PaymentInfo();
    BeanUtils.copyProperties(requestDTO, paymentInfo);
    paymentInfo.setOperator(requestDTO.getUserId());
